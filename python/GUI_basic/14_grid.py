...
btn_1 = Button(root, text="4", width=5, height=2)
btn_2 = Button(root, text="5", width=5, height=2)
btn_3 = Button(root, text="6", width=5, height=2)
