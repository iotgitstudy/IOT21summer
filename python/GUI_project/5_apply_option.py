...
def merge_image():
    ...
    # 스케치북 준비
    result_img = Image.new("RGB", (max_width, total_height), (255,255,255)) # 배경 색 
    y_offset = 0 # y 위치
    ...
    for idx, img in enumerate(images):
        ...
        progress = (idx + 1)/len(images) * 100 # 실제 퍼센트 계산
        p_var.set(progress)
        progress_bar.update()

    dest_path = os.path.join(txt_dest_path.get(), "testphoto.jpg")
